  ...
  return (
    <div className="flex justify-center items-center bg-blue-300 h-[100vh]">
      <div className=" flex flex-col justify-center items-center gap-y-5">
        ...
        <h2 className="font-Nunito font-bold text-4xl text-blue-500">{displayName?displayName:null}</h2>
        <h2 className="font-Nunito font-bold text-4xl">Please verify your {email?email:"example@gmail.com"}</h2>
